...
- **Entitlements File**: `Config/ChicagoRail.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/ChicagoRail.entitlements`:
